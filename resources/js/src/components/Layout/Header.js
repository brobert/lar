              ...
              <nav className="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row"> 
                    ...
                    <ul className="nav navbar-nav mr-auto">
                         <li className="nav-item">
                            <span className="button-toggle-nav inline-block ml-20 pull-left" onClick={this.togglebutton} >
                                <i className="zmdi zmdi-menu ti-align-right"></i>
                            </span>
                        </li>
                        <li className="nav-item">
                            <div className="search">
                                <span className="search-btn not_click"></span>
                    ...
                    <ul className="nav navbar-nav ml-auto">
                        ...
                        <li className="nav-item fullscreen">
                            <span id="btnFullscreen" className="nav-link" ><i className="ti-fullscreen"></i></span>
                        </li>
                        <li className="nav-item dropdown ">
                            <span className="nav-link top-nav" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
