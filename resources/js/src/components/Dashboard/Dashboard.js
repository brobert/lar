                        ...
                        <Card className="h-100">
                            ...
                            <div className="btn-group info-drop">
                                <Dropdown isOpen={this.state.dropdownbarOpen} toggle={this.dropdownbarOpen}>
                                    ...
                                    <DropdownMenu>
                                        <DropdownItem onClick={()=>{this.fetchChartData('bar')}} ><i className="text-primary ti-reload" />Refresh Chart</DropdownItem>
                            ...
                            <CardBody>
                                ...
                                <div className="row h-10 justify-content-center align-items-center">
                                    {
                                        this.state.barData && this.state.barData.datasets ?
                                        (
                                            this.state.barData.datasets.map((dataSet, idx) => {
                                                const isNegative = dataSet.summary.diff < 0;
                                                return (
                                                    <div key={idx} className="col-6 text-center">
                                                        <h6>{dataSet.label}</h6>
                                                        <b className={isNegative ? 'text-danger': 'text-success'}>
                                                            {!isNegative ? '+': '-'} {Math.abs(dataSet.summary.diff)} % 
                                                        </b>
                                                    </div>
                                                );
                                            })
                        ...
                        <Card className="h-100">
                            ...
                            <div className="btn-group info-drop">
                                <Dropdown isOpen={this.state.dropdownlineOpen} toggle={this.dropdownlineOpen}>
                                    ...
                                    <DropdownMenu>
                                        <DropdownItem onClick={()=>{this.fetchChartData('line')}} ><i className="text-primary ti-reload" />Refresh</DropdownItem>
                                        <DropdownItem><i className="text-secondary ti-eye" />View all</DropdownItem>
                                    </DropdownMenu>
                                </Dropdown>
                            ...
                            <CardBody>
                                ...
                                <div className="chart-wrapper" style={{height: 350}}>
                                <Line data={this.state.lineData} className="scrollbar-x text-center" options={{maintainAspectRatio: false, legend: {display: true, labels: {fontFamily: "Poppins"}}, scales: {yAxes: [{gridLines: {display: false}, ticks:{fontFamily: "Poppins"}}], xAxes: [{gridLines: {display: false},ticks:{fontFamily: "Poppins"}}]}}} />
                                </div>
                            </CardBody>
                        </Card>
                    </Col>
